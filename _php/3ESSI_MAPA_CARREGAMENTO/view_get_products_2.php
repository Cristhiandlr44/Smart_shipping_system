            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <table id="tabelaDetalhado" class="table table-bordered">
                        ...
                        <tbody id="tabelaDetalhadoBodyNormais">
                            <!-- Dados de entregas normais serão carregados aqui -->
                        </tbody>
                    </table>

                    <!-- Tabela para reentregas (armazém) -->
                    <h5>Reentregas (Armazém)</h5>
                    <table id="tabelaDetalhadoArmazem" class="table table-bordered">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Operação</th>
                        ...
                        <tbody id="tabelaDetalhadoBodyArmazem">
                            <!-- Dados de reentregas serão carregados aqui -->
                        </tbody>
                    </table>
                </div>
            </div>
