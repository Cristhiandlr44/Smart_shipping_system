...
$relative = isset($_POST['relative']) ? $_POST['relative'] : '';
  ...
  if($_SESSION["tipo"] == 1){
    ...
    echo '<li class="nav-item dropdown">
      ...
      <div class="dropdown-menu" style="background-color: white; padding: 5px 0; margin-top: -7px;">
        <a class="dropdown-item" id="devolucoes-tab" href="'.$relative.'3ESSI_DEVOLUCOES/view_devolucoes.php" role="tab" aria-controls="Inserir" aria-selected="false">Devoluções em Estoque Notas</a>
